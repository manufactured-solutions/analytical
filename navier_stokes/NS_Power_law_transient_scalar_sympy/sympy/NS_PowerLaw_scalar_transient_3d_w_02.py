...
execfile("NS_PowerLaw_scalar_transient_3d_w_01.py")
...
Q3n=collect(Q3n,AUX01*DMu_Dz*pi/L)
...
Res=Q_w_new-(Q_w_convection+Q_w_gradp+Q_w_viscous+Q_w_time)
Res==0 #true
