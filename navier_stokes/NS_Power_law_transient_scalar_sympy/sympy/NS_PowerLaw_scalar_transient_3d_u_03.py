...
execfile("NS_PowerLaw_scalar_transient_3d_u_02.py")
...
if name == y or name==Y:
  if Results == 0:
    ...
    print 'Successfull factorization: Q_u'
    print 'Writing C code for Q_u  -> ../C_codes/NS_PowerLaw_scalar_transient_3d_u.c'
    execfile("NS_PowerLaw_scalar_transient_3d_u_codes.py")  
    print 'Done.'
  else:
...
if numerical_tests == y or numerical_tests == Y:
 execfile("NS_PowerLaw_scalar_transient_3d_u_check_numerically.py")
 print 'Done.'


#   execfile("NS_Power Law_scalar_transient_3d_u_02.py")