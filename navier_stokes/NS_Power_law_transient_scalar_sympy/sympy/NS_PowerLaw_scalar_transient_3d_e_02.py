...
execfile("NS_PowerLaw_scalar_transient_3d_e_01.py")
...
# Q3 ------------------------------------------------------------------
var("Mu, DMu_Dx, DMu_Dy, DMu_Dz,AUX01,LAMBDA,kappa")
...
Q3n=collect(Q3n,[AUX01*U*DMu_Dx*pi/L])

Q3n=collect(Q3n,[AUX01*V*DMu_Dy*pi/L])
Q3n=collect(Q3n,[AUX01*W*DMu_Dz*pi/L])
