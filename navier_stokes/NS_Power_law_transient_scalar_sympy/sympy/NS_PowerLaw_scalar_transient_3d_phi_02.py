...
execfile("NS_PowerLaw_scalar_transient_3d_phi_01.py")
...
if name == y or name==Y:
  if Res1 == 0:
    ...
    print 'Writing C code for Q_phi  -> ../C_codes/NS_PowerLaw_scalar_transient_3d_phi.c'
    execfile("NS_PowerLaw_scalar_transient_3d_phi_codes.py")  
    print 'Done.'
  else:
...
if numerical_tests == y or numerical_tests == Y:
 execfile("NS_PowerLaw_scalar_transient_3d_phi_check_numerically.py")
 print 'Done.'
