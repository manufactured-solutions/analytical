...
execfile("NS_PowerLaw_scalar_transient_3d_v_02.py")
...
if name == y or name==Y:
  if Results == 0:
    ...
    print 'Writing C code for Q_v  -> ../C_codes/NS_PowerLaw_scalar_transient_3d_v.c'
    execfile("NS_PowerLaw_scalar_transient_3d_v_codes.py")  
    print 'Done.'
  else:
...
if numerical_tests == y or numerical_tests == Y:
 execfile("NS_PowerLaw_scalar_transient_3d_v_check_numerically.py")
 print 'Done.'
