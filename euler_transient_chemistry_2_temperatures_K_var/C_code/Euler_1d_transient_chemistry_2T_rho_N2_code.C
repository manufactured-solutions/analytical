...
double SourceQ_rho_N2 (double x, double t)
{
  ...
  Q_rho_N2 = -a_rho_N2_x * PI * rho_N2_x * U * sin(a_rho_N2_x * PI * x / L) / L + a_ux * PI * u_x * RHO_N2 * cos(a_ux * PI * x / L) / L + a_rho_N2_t * PI * rho_N2_t * cos(a_rho_N2_t * PI * t / L) / L - w_dot_N2;
  return(Q_rho_N2);
}
